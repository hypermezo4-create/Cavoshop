        ...
        <div className="p-6 lg:p-10 space-y-10">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
                ...
                <div className="xl:col-span-2 space-y-6">
                    <div className="flex items-center justify-between">
                        <h3 className="text-[10px] font-black text-zinc-600 uppercase tracking-[0.3em] flex items-center gap-2">
                            <ShieldCheck className="text-amber-500 w-3 h-3" /> Core Infrastructure Staff
                        </h3>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {[
                            { name: "Adi", role: "STORE MANAGER", email: "admin@cavostore.com", instagram: "mohammadadi" },
                            { name: "Neon Staff", role: "OPERATIONS", email: "ops@cavostore.com", instagram: "neon-db" }
                        ].map((user, i) => (
                            <motion.div
                                key={i}
                                ...
                                className="glass-premium p-6 rounded-[2.5rem] group hover:border-amber-500/30 transition-all relative overflow-hidden"
                            >
                                ...
                                <div className="relative z-10 flex items-center gap-5 mb-6">
                                    <div className="w-16 h-16 rounded-[1.5rem] bg-gradient-to-br from-amber-600 to-amber-400 flex items-center justify-center font-black text-white shadow-2xl shadow-amber-500/20 text-xl border border-white/10">
                                        {user.name[0]}
                                    </div>
                                    <div className="min-w-0">
                                        <h4 className="font-black text-white text-lg tracking-tight truncate">{user.name}</h4>
                                        <span className="text-[9px] font-black text-amber-400 tracking-[0.2em] uppercase">{user.role}</span>
                                    </div>
                                </div>
                                ...
                                <div className="relative z-10 space-y-4">
                                    ...
                                    <div className="flex gap-3">
                                        ...
                                        <button className="flex-1 flex items-center justify-center gap-2 py-3 bg-amber-500/10 hover:bg-amber-500/20 rounded-[1rem] text-amber-400 transition-all border border-amber-500/10">
                ...
                <div className="space-y-6">
                    <h3 className="text-[10px] font-black text-zinc-600 uppercase tracking-[0.3em] flex items-center gap-2">
                        <Terminal className="text-amber-500 w-3 h-3" /> Authority Nodes
                    </h3>

                    <div className="glass-premium p-8 rounded-[3rem] space-y-8 relative overflow-hidden">
                        <div className="absolute -top-10 -right-10 w-40 h-40 bg-amber-600/10 blur-[80px] rounded-full" />
                        ...
                        <div className="pt-4">
                            <div className="p-6 rounded-3xl bg-amber-600/10 border border-amber-600/20 text-center">
                                <Globe className="w-6 h-6 text-amber-400 mx-auto mb-3" />
                                ...
                                <p className="text-zinc-500 text-[10px] font-medium leading-normal italic">
                                    Integration with Cavo Global ID system is 82% complete.
                                </p>
                            </div>
                        </div>
                    </div>
