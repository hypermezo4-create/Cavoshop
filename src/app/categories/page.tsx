...
const products = [
  { name: "Collections Runner", tag: "Best Seller" },
  { name: "Collections Street Low", tag: "New Drop" },
  { name: "Collections Classic", tag: "Everyday" },
  { name: "Collections Elite", tag: "Premium" },
];
export default function CategoryPage() {
  ...
  <motion.h1 initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} className="text-5xl font-black text-white mb-4">Browse Collections</motion.h1>
  <p className="text-zinc-400 max-w-2xl mb-10">Discover standout pairs from the Cavo Collections lineup. Clean design, premium comfort, and versatile styling.</p>
